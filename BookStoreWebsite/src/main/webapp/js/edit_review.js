...
table.addEventListener('click', (e)=>{
  ...
  if(e.target.classList.contains("delete-book")){
    ...
    window.location.href = `http://localhost:8086/BookStoreWebsite/admin/edit_review?id=${id}`  ;
  } 
});
...
okBtn.addEventListener('click'  , ()=>{
  removeMenu();
  window.location.href =`http://localhost:8086/BookStoreWebsite/admin/delete_review?id=${id}` ;
});
