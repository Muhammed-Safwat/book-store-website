...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      ...
      <title>${customer.fullName} | edit profile</title>
    </head>
        ...
        <div class="container">
          <form action="edit-customer-profile" method='post' class="create-user-form row">
            ...
            <div class="input-row col-6 mb-3">
              ...
              <input type="text" id="name" value="${customer.fullName}"
			...
			<div class="input-row col-6 mb-3">
              ...
              <input type="text" id="zip-code" value="${customer.zipcode }"
              	 name="zip-code" class="form-control" required>
            </div>
            
            <div class="input-row col-6 mb-3">
              <label for="country">Country</label>
              <input type="text" id="country" value="${customer.country }"
